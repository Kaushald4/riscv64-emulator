...
impl Memory {
    ...
    pub fn read8(&self, addr: u64) -> Result<u8, Trap> {
        ...
        self.check(addr, 1, Trap::LoadAccessFault(addr as u64))?;
    ...
    pub fn read16(&self, addr: u64) -> Result<u16, Trap> {
        ...
        self.check(addr, 2, Trap::LoadAccessFault(addr as u64))?;
    ...
    pub fn read32(&self, addr: u64) -> Result<u32, Trap> {
        ...
        self.check(addr, 4, Trap::LoadAccessFault(addr as u64))?;
    ...
    pub fn read64(&self, addr: u64) -> Result<u64, Trap> {
        ...
        self.check(addr, 8, Trap::LoadAccessFault(addr as u64))?;
    ...
    pub fn write8(&mut self, addr: u64, value: u8) -> Result<(), Trap> {
        ...
        self.check(addr, 1, Trap::StoreAccessFault(addr as u64))?;
    ...
    pub fn write16(&mut self, addr: u64, value: u16) -> Result<(), Trap> {
        ...
        self.check(addr, 2, Trap::StoreAccessFault(addr as u64))?;
    ...
    pub fn write32(&mut self, addr: u64, value: u32) -> Result<(), Trap> {
        ...
        self.check(addr, 4, Trap::StoreAccessFault(addr as u64))?;
    ...
    pub fn write64(&mut self, addr: u64, value: u64) -> Result<(), Trap> {
        ...
        self.check(addr, 8, Trap::StoreAccessFault(addr as u64))?;
    ...
    pub fn load(&mut self, addr: u64, bytes: &[u8]) -> Result<(), Trap> {
        ...
        self.check(addr, bytes.len(), Trap::StoreAccessFault(addr as u64))?;
